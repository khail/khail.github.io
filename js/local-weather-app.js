...
var bgURL = {
    ...
    i01n: 'farm2.staticflickr.com/1655/23899871142_a19233705d_b.jpg',
...
function setLoc(position) {
    var id = 'd399f5bef04f797e1957ce6484ec7ea8';
    var lat = position.coords.latitude;
    var long = position.coords.longitude;
    var weatherURL = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat +
        '&lon=' + long + '&APPID=' + id + '&units=metric';

    $.getJSON(weatherURL, displayWeather);
}

function displayWeather(data) {
    var fullBgURL = 'url( https://' + bgURL['i' + data.weather[0].icon] + ' )';
    $('#backdrop').css({
        'background-image': fullBgURL
    });
